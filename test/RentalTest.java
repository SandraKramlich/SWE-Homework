...
public class RentalTest {
    ...
    public void testFrequentRenterPoints() throws Exception{
    	assertEquals(2, r1.getMovie().price.getFrequentRenterPoints(r1.getDaysRented()),0);
    	assertEquals(1, r2.getMovie().price.getFrequentRenterPoints(r2.getDaysRented()),0);
    }
}